...
var _search = _interopRequireDefault(__webpack_require__(/*! ./pages/search/search.vue */ 64));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}_vue.default.prototype.$http = (0, _index.default)();_vue.default.prototype.$store = _index2.default;var cuCustom = function cuCustom() {return __webpack_require__.e(/*! import() | colorui/components/cu-custom */ "colorui/components/cu-custom").then(__webpack_require__.bind(null, /*! ./colorui/components/cu-custom.vue */ 209));};_vue.default.component('cu-custom', cuCustom);var tabbar = function tabbar() {return Promise.all(/*! import() | components/tabbar/tabbar */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/tabbar/tabbar")]).then(__webpack_require__.bind(null, /*! ./components/tabbar/tabbar.vue */ 214));};_vue.default.component('tabbar', tabbar);_vue.default.component('addition', _addition.default);_vue.default.component('information', _information.default);_vue.default.component('store', _store.default);_vue.default.component('discovery', _discovery.default);var user = function user() {return Promise.all(/*! import() | pages/user/user */[__webpack_require__.e("common/vendor"), __webpack_require__.e("pages/user/user")]).then(__webpack_require__.bind(null, /*! ./pages/user/user.vue */ 221));};_vue.default.component('user', user);var authorization = function authorization() {return __webpack_require__.e(/*! import() | pages/authorization/authorization */ "pages/authorization/authorization").then(__webpack_require__.bind(null, /*! ./pages/authorization/authorization.vue */ 228));};_vue.default.component('authorization', authorization);
_vue.default.component('search', _search.default);var loading = function loading() {return __webpack_require__.e(/*! import() | components/loading/loading */ "components/loading/loading").then(__webpack_require__.bind(null, /*! ./components/loading/loading.vue */ 233));};


_vue.default.component('loading', loading);var notification = function notification() {return __webpack_require__.e(/*! import() | components/notification/notification */ "components/notification/notification").then(__webpack_require__.bind(null, /*! ./components/notification/notification.vue */ 240));};
...
//
//
var qqmapsdk = new _qqmapWxJssdk.default({ key: 'QL7BZ-ZCJKK-72IJS-A6NA6-HRJ3F-ZYB6J' });var _default = { data: function data() {return { currentNav: 0, currentTab: 1, newsInfo: [], attentionInfo: [], articleInfo: [], activityInfo: [], recruitInfo: [], menu_list: ['关注', '活动', '动态', '招募'], scroll_height: 700, displayLocation: '', imageList: [], attention_height: 700, article_height: 700, activity_height: 700, recruit_height: 700, fixTabbar: false, tabbar_top: _vue.default.prototype.CustomBar, loadingItem: false, loading: true, attention_scroll: 1, activity_scroll: 1, article_scroll: 1, recruit_scroll: 1, page_scroll: 1, loadingNext: false, links: [], newsCurrentPage: 1, attentionCurrentPage: 1, activityCurrentPage: 1, articleCurrentPage: 1, recruitCurrentPage: 1, newsComplete: false, attentionComplete: false, activityComplete: false, articleComplete: false, recruitComplete: false };}, computed: { currentScrollHeight: function currentScrollHeight() {if (this.currentTab == 1) {return this.activity_height;} else if (this.currentTab == 2) {return this.article_height;} else if (this.currentTab == 3) {return this.recruit_height;} else {return this.attention_height;}} }, mounted: function mounted() {var _this = this;var that = this;setTimeout(function () {_this.getHeight();}, 100);_vue.default.prototype.$http.request({ url: '/information/recommend', method: 'POST' }).then(function (res) {_this.newsInfo = res.data.data.news.data;for (var item in _this.newsInfo) {for (var index in _this.newsInfo[item].news_images) {_this.imageList.push(_this.newsInfo[item].news_images[index].image_url);}}_this.attentionInfo = res.data.data.attentions.data;for (var _item in _this.attentionInfo) {for (var _index in _this.attentionInfo[_item].article_images) {_this.imageList.push(_this.attentionInfo[_item].article_images[_index].image_url);}_this.formatAttentionContent(_item);_this.formatAttentionTime(_item);}_this.articleInfo = res.data.data.articles.data;for (var _item2 in _this.articleInfo) {for (var _index2 in _this.articleInfo[_item2].article_images) {_this.imageList.push(_this.articleInfo[_item2].article_images[_index2].image_url);}_this.formatArticleContent(_item2);_this.formatArticleTime(_item2);}_this.activityInfo = res.data.data.activities.data;for (var _item3 in _this.activityInfo) {for (var _index3 in _this.activityInfo[_item3].activity_images) {_this.imageList.push(_this.activityInfo[_item3].activity_images[_index3].image_url);}_this.formatActivityContent(_item3);_this.formatActivityTime(_item3);}_this.recruitInfo = res.data.data.recruits.data;for (var _item4 in _this.recruitInfo) {for (var _index4 in _this.recruitInfo[_item4].recruit_images) {_this.imageList.push(_this.recruitInfo[_item4].recruit_images[_index4].image_url);}_this.formatRecruitContent(_item4);_this.formatRecruitTime(_item4);}_this.loading = false;});}, methods: { formatArticleContent: function formatArticleContent(index) {this.articleInfo[index].article_content = this.articleInfo[index].article_content.replace(/<br\/\>/g, "\n");}, formatActivityContent: function formatActivityContent(index) {this.activityInfo[index].activity_content = this.activityInfo[index].activity_content.replace(/<br\/\>/g, "\n");}, formatRecruitContent: function formatRecruitContent(index) {this.recruitInfo[index].recruit_content = this.recruitInfo[index].recruit_content.replace(/<br\/\>/g, "\n");}, formatAttentionContent: function formatAttentionContent(index) {this.attentionInfo[index].article_content = this.attentionInfo[index].article_content.replace(/<br\/\>/g, "\n");}, loadNextPage: function loadNextPage() {var _this2 = this;if (this.loadingNext) {return;}var currentPage = 0;if (this.currentNav == 1) {if (this.currentTab == 1) {if (this.activityComplete) {return;}this.activityCurrentPage++;currentPage = this.activityCurrentPage;} else if (this.currentTab == 2) {if (this.articleComplete) {return;}this.articleCurrentPage++;currentPage = this.articleCurrentPage;} else if (this.currentTab == 3) {if (this.recruitComplete) {return;}this.recruitCurrentPage++;currentPage = this.recruitCurrentPage;} else {if (this.attentionComplete) {return;}this.attentionCurrentPage++;currentPage = this.attentionCurrentPage;}this.loadingNext = true;_vue.default.prototype.$http.request({ url: '/information/recommend?page=' + currentPage, method: 'POST' }).then(function (res) {if (_this2.currentTab == 1) {if (res.data.data.activities.data.length == 0) {_this2.activityComplete = true;_this2.loadingNext = false;return;}_this2.activityInfo.push.apply(_this2.activityInfo, res.data.data.activities.data);for (var item = (currentPage - 1) * 10; item < _this2.activityInfo.length; item++) {for (var index in _this2.activityInfo[item].activity_images) {_this2.imageList.push(_this2.activityInfo[item].activity_images[index].image_url);}_this2.formatActivityTime(item);_this2.formatActivityContent(item);}setTimeout(function () {var query = uni.createSelectorQuery().in(_this2);query.select('#activity').boundingClientRect(function (res) {_this2.activity_height = res.height;}).exec();}, 30);} else if (_this2.currentTab == 2) {if (res.data.data.articles.data.length == 0) {_this2.articleComplete = true;_this2.loadingNext = false;return;}_this2.articleInfo.push.apply(_this2.articleInfo, res.data.data.articles.data);for (var _item5 = (currentPage - 1) * 10; _item5 < _this2.articleInfo.length; _item5++) {for (var _index5 in _this2.articleInfo[_item5].article_images) {_this2.imageList.push(_this2.articleInfo[_item5].article_images[_index5].image_url);}_this2.formatArticleTime(_item5);_this2.formatArticleContent(_item5);}setTimeout(function () {var query = uni.createSelectorQuery().in(_this2);query.select('#article').boundingClientRect(function (res) {_this2.article_height = res.height;}).exec();}, 30);} else if (_this2.currentTab == 3) {if (res.data.data.recruits.data.length == 0) {_this2.recruitComplete = true;_this2.loadingNext = false;return;}_this2.recruitInfo.push.apply(_this2.recruitInfo, res.data.data.recruits.data);for (var _item6 = (currentPage - 1) * 10; _item6 < _this2.recruitInfo.length; _item6++) {for (var _index6 in _this2.recruitInfo[_item6].recruit_images) {_this2.imageList.push(_this2.recruitInfo[_item6].recruit_images[_index6].image_url);}_this2.formatRecruitTime(_item6);_this2.formatRecruitContent(_item6);}setTimeout(function () {var query = uni.createSelectorQuery().in(_this2);query.select('#recruit').boundingClientRect(function (res) {_this2.recruit_height = res.height;}).exec();}, 30);} else {if (res.data.data.attentions.data.length == 0) {_this2.attentionComplete = true;_this2.loadingNext = false;return;}_this2.attentionInfo.push.apply(_this2.attentionInfo, res.data.data.attentions.data);for (var _item7 = (currentPage - 1) * 10; _item7 < _this2.attentionInfo.length; _item7++) {for (var _index7 in _this2.attentionInfo[_item7].article_images) {_this2.imageList.push(_this2.attentionInfo[_item7].article_images[_index7].image_url);}_this2.formatAttentionTime(_item7);_this2.formatAttentionContent(_item7);}setTimeout(function () {var query = uni.createSelectorQuery().in(_this2);query.select('#attention').boundingClientRect(function (res) {_this2.attention_height = res.height;}).exec();}, 30);}_this2.loadingNext = false;});} else {if (this.newsComplete) {return;}this.newsCurrentPage++;currentPage = this.newsCurrentPage;this.loadingNext = true;_vue.default.prototype.$http.request({ url: '/information/recommend?page=' + currentPage, method: 'POST' }).then(function (res) {if (res.data.data.news.data.length == 0) {_this2.newsComplete = true;_this2.loadingNext = false;return;}_this2.newsInfo.push.apply(_this2.newsInfo, res.data.data.news.data);for (var item = (currentPage - 1) * 10; item < _this2.newsInfo.length; item++) {for (var index in _this2.newsInfo[item].news_images) {_this2.imageList.push(_this2.newsInfo[item].news_images[index].image_url);}}});}}, pageScroll: function pageScroll(e) {if (this.currentNav == 1) {if (e.detail.scrollTop >= 50) {this.fixTabbar = true;} else {this.fixTabbar = false;}if (this.currentTab == 0) {this.attention_scroll = e.detail.scrollTop;} else if (this.currentTab == 1) {this.activity_scroll = e.detail.scrollTop;
    ...
    navigateNews: function navigateNews(news_id) {
      uni.navigateTo({
        url: '/pages/news/news?news_id=' + news_id });

    },
    navigateArticle: function navigateArticle(article_id, comment) {
      uni.navigateTo({
        url: '/pages/article/article?article_id=' + article_id + '&comment=' + comment });

    },
    navigateActivity: function navigateActivity(activity_id, comment) {
      uni.navigateTo({
        url: '/pages/activity/activity?activity_id=' + activity_id + '&comment=' + comment });

    },
    navigateRecruit: function navigateRecruit(recruit_id, comment) {
      uni.navigateTo({
    ...
    likeRecruit: function likeRecruit(index, recruit_id) {var _this3 = this;
