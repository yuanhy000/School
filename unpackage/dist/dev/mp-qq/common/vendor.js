...
{
  actions: {
    getAroundPoi: function getAroundPoi(_ref,

    data) {var dispatch = _ref.dispatch;
    ...
    getInputTips: function getInputTips(_ref2,

    data) {var dispatch = _ref2.dispatch;
...
var base64 = __webpack_require__(/*! ./base64.js */ 93); //Base64,hmac,sha1,crypto相关算法
__webpack_require__(/*! ./hmac.js */ 94);
__webpack_require__(/*! ./sha1.js */ 96);

var Crypto = __webpack_require__(/*! ./crypto.js */ 95);
