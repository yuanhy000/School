<template>
    <view class="component-img-lazyload">
        ...
        >
            <image v-if="path.loading" :src="path.loading" class="loading-img" mode="widthFix" />

            <view v-show="imgLoadState.start" class="component-loading">
                <loading-export :type="componentName.loading" />
            </view>
        </anime-state-switch>
        ...
        >
            <image v-if="path.error" :src="path.error" class="error-img" mode="widthFix" />

            <view class="component-error">
                <error-export :type="componentName.error" />
            </view>
        </anime-state-switch>
    </view>
</template>
